...
export interface ApiMahasiswaMahasiswa extends Schema.CollectionType {
  ...
  attributes: {
    NamaMahasiswa: Attribute.Text;
    NPM: Attribute.String;
    mata_kuliah: Attribute.Relation<
      'api::mahasiswa.mahasiswa',
      'manyToOne',
      'api::mata-kuliah.mata-kuliah'
    >;
...
export interface ApiMataKuliahMataKuliah extends Schema.CollectionType {
  collectionName: 'mata_kuliahs';
  info: {
    singularName: 'mata-kuliah';
    pluralName: 'mata-kuliahs';
  ...
  attributes: {
    NamaMatkul: Attribute.String;
    KodeMatkul: Attribute.String;
...
export interface ApiNilaiNilai extends Schema.CollectionType {
  ...
  attributes: {
    NilaiMhs: Attribute.Decimal;
    TanggalUjian: Attribute.Date;
    mahasiswa: Attribute.Relation<
      'api::nilai.nilai',
      'oneToOne',
      'api::mahasiswa.mahasiswa'
    >;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::mata-kuliah.mata-kuliah': ApiMataKuliahMataKuliah;
